...
from model_svm import preprocess_image, load_model, evaluate_model, train_and_evaluate_model, load_data
...
def main():
    ...
    selected_supervised_model = st.selectbox("Select Supervised Model:", ['svm.joblib','svm_without_data_aug.joblib', 'knn.joblib', 'nn.joblib', 'log.joblib', 'decision_t.joblib','nb.joblib','gbt.joblib','rf.joblib'])
    ...
    # Specify the path to the zip file and the destination folders
    zip_path = "three_shapes_filled.zip"
    extracted_folder = "three_shapes_filled"

    # Unzip the folder
    unzip_folder(zip_path, extracted_folder)

    # Now, you can use the extracted_folder path in your code to load and preprocess the data
    # For example, you can use it in the load_data function:
    ...
    supervised_model_names = ['svm.joblib','svm_without_data_aug.joblib', 'knn.joblib', 'nn.joblib', 'log.joblib', 'decision_t.joblib','nb.joblib','gbt.joblib','rf.joblib']
